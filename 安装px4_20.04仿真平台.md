...
# 进行安装
apt install ros-foxy-catkin
apt install ros-foxy-desktop ros-dev-tools ros-foxy-mavros ros-foxy-mavros-extras ros-foxy-mavlink ros-foxy-gazebo-ros-pkgs ros-foxy-image-view ros-foxy-cv-bridge -y
