...
class Ui_fly_app(object):
    def setupUi(self, fly_app):
        ...
        self.groupBox_5.setGeometry(QtCore.QRect(470, 280, 331, 201))
        ...
        self.textBrowser.setGeometry(QtCore.QRect(10, 490, 791, 101))
        ...
        self.tabWidget.setGeometry(QtCore.QRect(480, 10, 321, 261))
        self.tabWidget.setObjectName("tabWidget")
        self.tab = QtWidgets.QWidget()
        self.tab.setObjectName("tab")
        self.label = QtWidgets.QLabel(self.tab)
        self.label.setGeometry(QtCore.QRect(0, 0, 320, 240))
        self.label.setObjectName("label")
        self.tabWidget.addTab(self.tab, "")
        self.real_graphicsView = PlotWidget(self.centralwidget)
        self.real_graphicsView.setGeometry(QtCore.QRect(810, 30, 261, 171))
        self.real_graphicsView.setObjectName("real_graphicsView")
        self.graphicsView = PlotWidget(self.centralwidget)
        self.graphicsView.setGeometry(QtCore.QRect(810, 220, 261, 171))
        self.graphicsView.setObjectName("graphicsView")
        self.aruco_real_wc_graphicsView = PlotWidget(self.centralwidget)
        self.aruco_real_wc_graphicsView.setGeometry(QtCore.QRect(810, 410, 261, 171))
        self.aruco_real_wc_graphicsView.setObjectName("aruco_real_wc_graphicsView")
        self.label_29 = QtWidgets.QLabel(self.centralwidget)
        self.label_29.setGeometry(QtCore.QRect(810, 10, 54, 12))
        self.label_29.setObjectName("label_29")
        self.label_30 = QtWidgets.QLabel(self.centralwidget)
        self.label_30.setGeometry(QtCore.QRect(810, 200, 61, 16))
        self.label_30.setObjectName("label_30")
        self.label_31 = QtWidgets.QLabel(self.centralwidget)
        self.label_31.setGeometry(QtCore.QRect(810, 390, 121, 16))
...
"y:{}m/s"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("fly_app", "相机"))
        self.label_29.setText(_translate("fly_app", "真实位置"))
        self.label_30.setText(_translate("fly_app", "识别位置"))
        self.label_31.setText(_translate("fly_app", "真实与识别误差"))
