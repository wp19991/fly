...
class Ui_fly_app(object):
    def setupUi(self, fly_app):
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(10, 100, 328, 161))
        ...
        self.limit_height_m_doubleSpinBox.setProperty("value", 1.0)
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(350, 100, 431, 151))
        ...
        self.label.setGeometry(QtCore.QRect(460, 250, 320, 240))
        self.label.setObjectName("label")
        self.textBrowser = QtWidgets.QTextBrowser(self.centralwidget)
        self.textBrowser.setGeometry(QtCore.QRect(10, 500, 781, 101))
        ...
        self.get_video_farme_pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.get_video_farme_pushButton.setGeometry(QtCore.QRect(360, 270, 81, 23))
        self.get_video_farme_pushButton.setObjectName("get_video_farme_pushButton")
        self.groupBox_4 = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox_4.setGeometry(QtCore.QRect(10, 10, 454, 81))
        ...
        self.groupBox.setGeometry(QtCore.QRect(480, 10, 301, 76))
...
"y:{}m/s"))
        ...
        self.get_video_farme_pushButton.setText(_translate("fly_app", "获取相机画面"))
